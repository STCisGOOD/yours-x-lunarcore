 ...
 *
 * This is the official BIP-39 wordlist used for mnemonic seed phrase generation.
 * Source: https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt
 *
 * SECURITY CRITICAL:
 * - These words are used for 128-bit entropy recovery phrases
 * - Each word maps to an 11-bit value (2^11 = 2048)
...
object Bip39Wordlist {
    ...
    val WORDLIST: List<String> = listOf(
        ...
        // ===== CHUNK 2: Words 512-1023 =====
        // Words 512-767:
        "divorce", "doctor", "document", "dog", "doll", "dolphin", "domain", "donate",
        ...
        // ===== CHUNK 3: Words 1024-1535 =====
        "lace", "ladder", "lady", "lake", "lamp", "language", "laptop", "large",
    ...
    fun getWord(index: Int): String {
        require(index in 0 until 2048) { "Index must be 0-2047, got $index" }
    ...
    fun getIndex(word: String): Int {
        return WORDLIST.indexOf(word.lowercase())
    }

    /**
     * Validate that a word is in the wordlist
     */
